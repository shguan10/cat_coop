    ...
    def __init__(self,
        ...
        if self.mode.lower() == 'train':
            ...
            self.train_labels = utils.get_files(
                ...
                extension_filter=self.img_extension)
        elif self.mode.lower() == 'val' or self.mode.lower() == 'test':
            ...
            self.test_labels = utils.get_files(
                ...
                name_filter=self.lbl_name_filter,
                extension_filter=self.img_extension)
            # goods = [i for i in range(len(self.test_labels)) if self.__is_allowed__(i)] 
            # self.test_data = [self.test_data[i] for i in goods]
            # self.test_labels = [self.test_labels[i] for i in goods]
            # pdb.set_trace()
